...
tend=15. | units.day   # usually 9 days                                     # end period
...
'''
#import xarray as xr
#test=xr.open_dataset('/projects/0/einf2224/tests/holland_era5_BS/ERA5_4GTSM_Irma_v3.nc')
#print('TEST:', test)
meteo=Data(source_dir="/projects/0/einf2224/tests/holland_era5_BS", source_file="ERA5_4GTSM_Irma_v3.nc", start_datetime=start_datetime, variables=["u10", "v10", "sp"], var_units = [units.m/units.s, units.m/units.s, units.Pa])
#meteo=Data(source_dir="/projects/0/einf2224/tests/era5_BS", source_file="ERA5_4GTSM_u10_Irma.nc", start_datetime=start_datetime, variables=["u10"], var_units = [units.m/units.s])

d=DFlowFM(number_of_workers=32, ini_file="/projects/0/einf2224/tests/model_template/gtsm_fine.mdu", coordinates="spherical")

# set parameters
d.parameters.use_interface_wind=True
d.parameters.use_interface_patm=True
d.ini_time.RefDate=start_date
d.ini_physics.TidalForcing=0
d.ini_output.MapInterval=0.
d.ini_output.HisInterval="3600.  172800.  777600."

d.ini_external_forcing.ExtForceFile="/projects/0/einf2224/tests/era5_BS/gtsm_fine_irma_holland_era5.ext"
d.ini_geometry.PartitionFile="/projects/0/einf2224/tests/model_template/step11_global_part.pol"
...
while d.model_time < tend-dt/2:
    ...
    channel1.copy_attributes(["u10", 
                              "v10"], 
                              target_names=["wind_vx",
                                            "wind_vy"])
    channel2.copy_attributes(["sp"], 
