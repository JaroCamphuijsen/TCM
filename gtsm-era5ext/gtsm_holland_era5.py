...
from omuse.community.delft3d.utilities import ext_force_file_creator
...
coordinates=[-82.5,-79.5,29.5,32.5]
...
d.ini_external_forcing.ExtForceFile="/gpfs/home2/jcamphuijsen/input/model_template/gtsm_fine_irma_holland_era5.ext"
# d.ini_external_forcing.ExtForceFile="/gpfs/home2/jcamphuijsen/input/model_template/gtsm_fine.ext" # try with file from only Holland model run
