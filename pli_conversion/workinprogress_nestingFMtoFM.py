...
dir_output = r'C:\Users\ibe202\OneDrive - Vrije Universiteit Amsterdam\Irene\Paper1\Scripts\Grid_refinement\test_nesting\output'
...
file_net = r'C:\Users\ibe202\OneDrive - Vrije Universiteit Amsterdam\Irene\Paper1\Scripts\Grid_refinement\test_nesting\gtsm_fine_0*_map.nc'
#file_net = r'C:\Users\ibe202\surfdrive\Irene\Paper2\data\gtsm\DFM_interpreted_network_gtsm_fine_net.nc'
crs_net = 'EPSG:4326'
data_xr = dfmt.open_partitioned_dataset(file_net)#.replace('_0000_','_0*_') #TODO: ValueError: Dimensions {'nNetElem'} do not exist. Expected one or more of Frozen({}) (xugrid flexible gridnames support?)
...
#print(data_xr.FlowElemContour_x)

#%%

#get and plot pli coordinates
file_pli_list = [Path(r'C:\Users\ibe202\OneDrive - Vrije Universiteit Amsterdam\Irene\Paper1\Scripts\Grid_refinement\dfm_tools\docs\notebooks\haiyan\haiyan.pli'),]
...
for file_pli in file_pli_list:
    kdtree_k = 4
    file_his = r'C:\Users\ibe202\OneDrive - Vrije Universiteit Amsterdam\Irene\Paper1\Scripts\Grid_refinement\test_nesting\gtsm_fine_0000_his.nc'
    ...
    file_bc_out=r'C:\Users\ibe202\OneDrive - Vrije Universiteit Amsterdam\Irene\Paper1\Scripts\Grid_refinement\test_nesting\output\haiyan.bc'
