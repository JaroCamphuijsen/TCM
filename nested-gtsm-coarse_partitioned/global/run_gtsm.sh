...
# Partitioning is executed by dflowfm, in the folder containing the mdu file
 ...
 srun -n 1 $singularitydir/execute_singularity_snellius.sh -p 1 run_dflowfm.sh --partition:ndomains=$nPart:icgsolver=6:genpolygon=1:contiguous=0  $mdufile
