...
def init_global(start_date):
    d=DFlowFM(number_of_workers=2, ini_file="gtsm_fine.mdu", coordinates="spherical", redirection="none", workdir="/gpfs/work2/0/einf2224/TCM/nested-gtsm_partitioned/global_haiyan")
    #d=DFlowFM(number_of_workers=32, ini_file="gtsm_fine.mdu", coordinates="spherical", redirection="none", workdir="global_haiyan")
    ...
    d.ini_external_forcing.ExtForceFile="gtsm_fine_forcing.ext"
...
def init_nested(start_date):
    d=DFlowFM(number_of_workers=2, ini_file="gtsm_fine.mdu", coordinates="spherical", redirection="none", workdir="/gpfs/work2/0/einf2224/TCM/nested-gtsm_partitioned/local_haiyan")
    ...
    d.ini_time.RefDate=start_date
    d.ini_external_forcing.ExtForceFile="gtsm_fine_forcing_waterlevelbnd.ext"
    #d.ini_external_forcing.ExtForceFile="gtsm_fine_forcing.ext" # no waterlevelbnd in the ext file
    d.ini_geometry.PartitionFile="haiyan5_part.pol"
    d.ini_numerics.Icgsolver=6
